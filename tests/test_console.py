...
This module contains:
    - TestHBNBCommand_prompting: Tests for prompt behavior.
    - TestHBNBCommand_help: Tests for help messages.
    - TestHBNBCommand_exit: Tests for exit commands.
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unit tests for testing the prompting behavior of
    the HBNB command interpreter."""

    @classmethod
    def setUpClass(self):
        """Initialize the HBNBCommand instance for testing."""
        self.typing = console.HBNBCommand()

    @classmethod
    def tearDownClass(self):
        """Clean up any temporary files created during
        testing (e.g., file.json)."""
        try:
            os.remove("file.json")
